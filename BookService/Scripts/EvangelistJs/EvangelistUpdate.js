$(function () {
    ...
    modelUpdate.getEvangelistDetails(selectedEvangelistId);
...
var modelUpdate = {
    ...
    getEvangelistDetails: function (selectedEvangelistId) {
        ...
        try {
            $.ajax({
                url: '/Evangelists?id=' + selectedEvangelistId,
                type: 'GET',
                dataType: 'json',
                contentType: 'application/json',
                headers: {
    ...
    gridViewModel: function () {
        ...
        //alert(this.modelUpdate.searchAssemblies());
    ...
    cropImage: function () {
        ...
        $("#dialogUploadImage").dialog("close");
        this.Photo(url);
    }
